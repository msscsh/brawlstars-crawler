...
def audit(tag, battles):
	...
	set_db_player_field_value(player.get('tag'), '5v5Wins', count_5v5_game_win)
	set_db_player_field_value(player.get('tag'), '5v5Losses', count_5v5_game_loss)
	set_db_player_field_value(player.get('tag'), '5v5Draws', count_5v5_game_draw)
